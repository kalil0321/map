...
/**
 * Generate a role URL slug
 * Format: /roles/{role-slug}
 */
export function generateRoleSlug(role: string): string {
  return slugify(role);
}

/**
 * Generate a location URL slug
 * Format: /locations/{location-slug}
 */
